...
const OverviewSection = () => {
  return (
    <div className="w-full max-w-[75rem] flex flex-col items-center gap-[1.5rem] lg:gap-[2rem] mx-auto mt-[-1rem] lg:mt-[-1rem]">
      ...
      <p className="w-full max-w-[53.75rem] text-[14px] lg:text-[20px] leading-[22px] lg:leading-[32px] text-center text-black font-roboto ">
